...
import org.apache.sling.sample.types.entity.commons.ItemsLink;
...
public class UserLinkProvider implements LinkProvider {
	...
	public Collection<@NotNull Link> getLinks() {
		return Arrays.asList(
			new RelPathLink(factory, "info", "info"),
			new ItemsLink(factory, "stream", "slingshot/Stream")
		);
	}
}
