...
@Component(
    property = {
        PropProvider.PROPERTY_RESOURCE_TYPE + "=/libs/slingshot/Stream"
    }
)
public class StreamPropProvider implements PropProvider {
    ...
    public Collection<@NotNull Prop> getProperties() {
        return Arrays.asList(
            new SimpleProp(attrsFactory, "title"),
            new SimpleProp(attrsFactory, "description")
        );
    }
}
